...
class _LedgerHomeState extends State<LedgerHome> with SingleTickerProviderStateMixin {
  ...
  late final Future<List<Category>> _filterCatsFuture;
  ...
  void initState() {
    ...
    _filterCatsFuture = _loadFilterCategories();
  }
  ...
  Future<void> _pickCategory(BuildContext context) async {
    ...
    final cats = await _filterCatsFuture;
                ...
                suffixIcon: !hasAny
                    ...
                    : Row(
                        ...
                        children: [
                          ...
                          IconButton(
                            tooltip: tr(context, en: 'Reset', zh: '重置'),
  ...
  String _fmtDay(DateTime dt) {(DateTime dt) {
                    ...
                    IconButton(
                      ...
                      onPressed: _selectedIds.isEmpty
                          ...
                          : () async {
                              ...
                              await (db.delete(db.transactions)..where((t) => t.id.isIn(_selectedIds.toList()))).go();
                                                ...
                                                if (_selectMode)
                                                  Positioned(
                                                    ...
                                                    child: IgnorePointer(
                                                      child: Checkbox(
                                                        value: selected,
                                                        onChanged: (_) {}, // keep enabled to avoid disabled-grey override
              ...
              floatingActionButton: FloatingActionButton(
                onPressed: () async {
                  await Navigator.push(
                    context,
                    MaterialPageRoute(builder: (_) => AddTransactionPage(db: db)),
                  );
                  _refreshHome();
                },
              ...
              child: LedgerSideMenu(
                ...
                onOpenSettings: () async {
                  ...
                  await Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (_) => SettingsPage(db: widget.db, onToggleLocale: onToggleLocale),
                    ),
                  );
                  _refreshHome();
                },
